...
The original assignment consisted of a regression nomogram of Taiwanese independence sentiments in 2016, referred to as *Tondu*, against named variables. I chose to remove non-respondents, which can be optionally reinstated in the code below.
